...
jieba.load_userdict("./MachineLearning/participle_dict/actor.txt")
jieba.load_userdict("./MachineLearning/participle_dict/genreDict.txt")
jieba.load_userdict("./MachineLearning/participle_dict/movieDict.txt")
jieba.load_userdict("./MachineLearning/participle_dict/scoreDict.txt")
